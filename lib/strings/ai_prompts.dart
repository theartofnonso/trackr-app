...
const addSetInstruction =
    "As a personal fitness trainer, analyze the intent behind my command to log weight and repetitions, and extract structured data such as the amount of weight or the number of repetitions.";
