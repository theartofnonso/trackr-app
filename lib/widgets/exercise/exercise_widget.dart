...
class ExerciseWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryMuscleGroupNames = exercise.secondaryMuscleGroups
        .map((muscleGroup) => muscleGroup.name.toUpperCase())
        .toList();

    return ListTile(
        onTap: () =>
            selectExercise != null ? selectExercise(exerciseDto) : null,
        ...
        trailing: GestureDetector(
          ...
          onTap: () => navigateToExercise != null
              ? navigateToExercise(exerciseDto)
              : null,
          child: FaIcon(
