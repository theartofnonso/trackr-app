...
/** This is an auto generated class representing the RoutineUser type in your schema. */
class RoutineUser extends amplify_core.Model {
  ...
  RoutineUserModelIdentifier get modelIdentifier {
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "RoutineUser";
    modelSchemaDefinition.pluralName = "RoutineUsers";
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: RoutineUser.DATA,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: RoutineUser.CREATEDAT,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: RoutineUser.UPDATEDAT,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
  });
...
class _RoutineUserModelType extends amplify_core.ModelType<RoutineUser> {
  const _RoutineUserModelType();
  
  @override
  RoutineUser fromJson(Map<String, dynamic> jsonData) {
    return RoutineUser.fromJson(jsonData);
  }
 ...
 * of [RoutineUser] in your schema.
 */
class RoutineUserModelIdentifier implements amplify_core.ModelIdentifier<RoutineUser> {
  final String id;

  /** Create an instance of RoutineUserModelIdentifier using [id] the primary key. */
  const RoutineUserModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'RoutineUserModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is RoutineUserModelIdentifier &&
      id == other.id;
  }
