...
class ExerciseProvider with ChangeNotifier {
  ...
  Future<void> uploadExercises() async {
    ...
    // final exercise = Exercise(name: "Triceps Extension", primary: ['Triceps'], secondary: [], bodyPart: BodyPart.Triceps, createdAt: TemporalDateTime.now(), updatedAt: TemporalDateTime.now());
