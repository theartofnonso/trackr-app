...
class DataHostApi {
  ...
  Future<bool> isWatchSynced() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.tracker_app.DataHostApi.isWatchSynced$__pigeon_messageChannelSuffix';
  ...
  Future<void> unSyncSession() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.tracker_app.DataHostApi.unSyncSession$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
