      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                CButtonWrapperWidget(onPressed: _navigateToActivityOverviewScreen, child: const  Icon(Icons.close, color: Colors.white,))
              ],
            ),
            Expanded(
              child: Consumer<ActivityProvider>(
                builder: (_, activityProvider, __) {
                  return ListView(
                    children: [
                      ... _activitiesToButtons(activities: activityProvider.activities)
                    ],
                  );
                }
              ),
