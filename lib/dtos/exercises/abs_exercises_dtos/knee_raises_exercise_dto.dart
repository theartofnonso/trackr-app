...
class KneeRaisesExerciseDto extends ExerciseDTO {

  @override
  String get id => "ABS_04";

  @override
  String get name => "Knee Raises";

  @override
  String get description => "Targets the lower abs by lifting the knees while suspended.";
