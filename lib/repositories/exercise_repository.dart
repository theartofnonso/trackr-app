...
class ExerciseRepository {
  ...
  void _loadQuadricepsExercises() {
    ...
    final splitSquatsExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing],
        equipment: [ExerciseEquipment.barbell, ExerciseEquipment.dumbbell, ExerciseEquipment.kettleBell, ExerciseEquipment.none],
        primaryMuscleGroups: [MuscleGroup.quadriceps],
        secondaryMuscleGroups: [MuscleGroup.hamstrings, MuscleGroup.glutes],
        coreMovement: CoreMovement.squat);
  ...
  void _loadBackExercises() {
    ...
    final pullUpsExercise = ExerciseDTO(
        ...
        equipment: [ExerciseEquipment.plate, ExerciseEquipment.dumbbell, ExerciseEquipment.kettleBell, ExerciseEquipment.assistedMachine, ExerciseEquipment.band],
        primaryMuscleGroups: [MuscleGroup.back],
        movements: [ExerciseMovement.reverse, ExerciseMovement.none],
        secondaryMuscleGroups: [MuscleGroup.biceps, MuscleGroup.shoulders],
        coreMovement: CoreMovement.pull);
  ...
  void _loadAbductorAdductorExercises() {
    ...
    final adductionExercise = ExerciseDTO(
        name: "Hip Adduction",
        description: "Targets the inner thigh muscles, specifically the adductors, to improve leg stability and strength.",
        metrics: [ExerciseMetric.weights],
        modes: [ExerciseModality.bilateral],
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.seated],
  ...
  void _loadShouldersExercises() {
    final raisesExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing, ExerciseStance.seated],
        equipment: [ExerciseEquipment.dumbbell, ExerciseEquipment.cableMachine, ExerciseEquipment.machine, ExerciseEquipment.plate, ExerciseEquipment.kettleBell, ExerciseEquipment.barbell],
    ...
    final uprightRowExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing, ExerciseStance.seated],
        equipment: [ExerciseEquipment.barbell, ExerciseEquipment.dumbbell, ExerciseEquipment.cableMachine, ExerciseEquipment.plate, ExerciseEquipment.kettleBell],
        primaryMuscleGroups: [MuscleGroup.shoulders],
        coreMovement: CoreMovement.push);
    ...
    final overheadExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing, ExerciseStance.seated],
        equipment: [ExerciseEquipment.barbell, ExerciseEquipment.machine, ExerciseEquipment.dumbbell, ExerciseEquipment.kettleBell],
        primaryMuscleGroups: [MuscleGroup.shoulders],
    ...
    final reverseExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing, ExerciseStance.seated],
        equipment: [ExerciseEquipment.cableMachine, ExerciseEquipment.machine, ExerciseEquipment.dumbbell, ExerciseEquipment.kettleBell],
        primaryMuscleGroups: [MuscleGroup.shoulders],
  ...
  void _glutesExercise() {
    final gluteBridgeExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.lying],
        equipment: [ExerciseEquipment.dumbbell, ExerciseEquipment.plate, ExerciseEquipment.kettleBell, ExerciseEquipment.barbell],
    ...
    final hipThrustExercise = ExerciseDTO(
        ...
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.lying],
        equipment: [ExerciseEquipment.dumbbell, ExerciseEquipment.plate, ExerciseEquipment.kettleBell, ExerciseEquipment.barbell, ExerciseEquipment.smithMachine, ExerciseEquipment.machine],
        primaryMuscleGroups: [MuscleGroup.glutes],
        secondaryMuscleGroups: [MuscleGroup.hamstrings, MuscleGroup.quadriceps, MuscleGroup.adductors, MuscleGroup.back],
        coreMovement: CoreMovement.hinge);
    ...
    final kickBacksExercise = ExerciseDTO(
        ...
        equipment: [ExerciseEquipment.cableMachine, ExerciseEquipment.machine, ExerciseEquipment.band, ExerciseEquipment.none],
        primaryMuscleGroups: [MuscleGroup.glutes],
        secondaryMuscleGroups: [MuscleGroup.hamstrings, MuscleGroup.quadriceps, MuscleGroup.adductors, MuscleGroup.back],
        coreMovement: CoreMovement.others);
  ...
  void absExercise() {
    ...
    final crunchesExercise = ExerciseDTO(
        ...
        stances: [ExerciseStance.lying],
        movements: [ExerciseMovement.reverse, ExerciseMovement.none],
        equipment: [ExerciseEquipment.none, ExerciseEquipment.machine, ExerciseEquipment.cableMachine, ExerciseEquipment.plate, ExerciseEquipment.dumbbell, ExerciseEquipment.kettleBell],
        primaryMuscleGroups: [MuscleGroup.abs],
        coreMovement: CoreMovement.others);
  ...
  void _calvesExercise() {
    ...
    final jumpRopeExercise = ExerciseDTO(
        name: "Jump Rope",
        description: "Engages the calves through repetitive jumping motions, building strength, endurance, and coordination while improving overall lower-body mobility and agility.",
        metrics: [ExerciseMetric.reps, ExerciseMetric.weights],
        modes: [ExerciseModality.unilateral, ExerciseModality.bilateral],
        positions: [ExercisePosition.neutral],
        stances: [ExerciseStance.standing],
