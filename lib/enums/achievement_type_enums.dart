enum AchievementType {
  ...
  obsessed("Obsessed", "Log at least one session for 12 consecutive weeks", 16),
  neverSkipAMonday("Never Skip a Monday", "Log sessions for 12 consecutive mondays", 16),
  neverSkipALegDay("Never Skip a Leg Day", "Log sessions with at least one leg exercise for 12 consecutive weeks", 16),
  sweatEquity("Sweat Equity", "Accumulate 20 hours of strength training", 100),
  weekendWarrior("Weekend Warrior", "Log a session on both Saturday and Sunday for four consecutive weeks", 8),
