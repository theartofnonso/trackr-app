...
class SharedPrefs {
  ...
  /// Show calendar
  final String _showCalendarKey = "show_calendar_key";

  bool get showCalendar => _sharedPrefs?.getBool(_showCalendarKey) ?? true;

  set showCalendar(bool value) {
    _sharedPrefs?.setBool(_showCalendarKey, value);
  }
